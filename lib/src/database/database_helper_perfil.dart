...
//constante estatica
  ...
  Future<void> _crearTabla(Database db, int version) async {
    await db.execute(
        "CREATE TABLE $_nombreTBL(id INTEGER PRIMARY KEY, avatar VARCHAR(100), nombre VARCHAR(100), aPaterno VARCHAR(100), aMaterno VARCHAR(100), telefono VARCHAR(15), email VARCHAR(100))");
  }
